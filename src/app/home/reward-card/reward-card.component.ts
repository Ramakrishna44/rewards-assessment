...
export class RewardCardComponent {
    ...
    ngAfterViewInit() {
        this.appService.sort$.subscribe((value) => {
            this.sortRewards(value);
        });
    }
    ...
    sortRewards(value: number) {
        // AtoZ
        if (value === 0) {
            this.displayData = [...this.rewardsData].sort((a: any,b: any) => a.name.localeCompare(b.name));
        } else if (value === 1) {
            this.displayData = [...this.rewardsData].sort((a: any,b: any) => b.name.localeCompare(a.name));
        } else {
            this.displayData = [...this.rewardsData];
        }
    }
